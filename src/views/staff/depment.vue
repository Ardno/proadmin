          ...
          <el-card class="box-card auto">
            ...
            <el-form v-else label-position="left" label-width="80px" :model="depInfo" v-loading="fromloading" class=" pl10 cusfom">
              ...
              <el-form-item  v-for="(pitem,index) in depInfodep.depArr" :label="'部门'+(index+1)" :key="pitem._id">
                ...
                <el-button v-show="isAccess('24')" class="r ml10" type="text" @click="handleUpdatePeInfo('1',pitem ,index)"> 修改</el-button>
                <el-button v-show="isAccess('24') && index===0" class="r ml10" type="text" @click="handleUpdatePeInfo('0',pitem,index)"> 添加</el-button>
              </el-form-item>
