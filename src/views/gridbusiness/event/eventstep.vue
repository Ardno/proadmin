<template>
  <div class="app-container">
    <div class="layui-elem-quote">
        ...
        <el-button class="filter-item" v-if="isAccess('71')" type="primary" icon="plus" @click="goOtherPage('')">新建</el-button>
    </div>
    <el-table :key='tableKey' :data="eventStepArr" v-loading="listLoading" element-loading-text="给我一点时间" border fit highlight-current-row style="width: 100%">
      ...
      <el-table-column align="center" label="操作" width="190">
        <template slot-scope="scope">
            <el-button size="small" type="primary" v-if="isAccess('72')" icon="edit" @click="goOtherPage(scope.row._id)">编辑
            </el-button>
        </template>
      </el-table-column>
    </el-table>
